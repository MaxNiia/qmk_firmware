...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
          KC_TRNS, KC_EXLM,LALT_T(KC_AT),LCTL_T(KC_HASH),LSFT_T(KC_LCBR),  KC_RCBR,                     KC_PERC,RSFT_T(KC_ASTR),RCTL_T(KC_PLUS),RALT_T(KC_EQUAL),KC_TRNS,     KC_TRNS,
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
  ...
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
          KC_TRNS, KC_HOME,LALT_T(KC_PGDN),LCTL_T(KC_PGUP), LSFT_T(KC_END),  KC_NO,                      KC_LEFT,RSFT_T(KC_DOWN),RCTL_T(KC_UP),RALT_T(KC_RGHT),    KC_NO,     KC_TRNS,
  //|------------+------------+------------+------------+------------+------------|                    |------------+------------+------------+------------+------------+------------|
